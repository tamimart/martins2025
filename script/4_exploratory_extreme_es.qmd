...
rob_no_extreme |> gt::gt()

print(paste(rob_no_extreme[2,2], "of", (rob_no_extreme[1,2] +  rob_no_extreme[2,2]), "studies that report not doing practices to reduce risk of bias are considered extremes (ES >= 5, SD >= 3)."))
```
